...
import (
	...
	"entgo.io/bug/ent/like"
	"entgo.io/bug/ent/predicate"
	"entgo.io/bug/ent/tweet"
...
func (m *LikeMutation) TweetIDs() (ids []uuid.UUID) {
...
func (m *TweetMutation) AddLikedUserIDs(ids ...uuid.UUID) {
...
func (m *TweetMutation) RemoveLikedUserIDs(ids ...uuid.UUID) {
...
func (m *TweetMutation) RemovedLikedUsersIDs() (ids []uuid.UUID) {
...
func (m *TweetMutation) LikedUsersIDs() (ids []uuid.UUID) {
...
type UserMutation struct {
	...
	name                *string
	clearedFields       map[string]struct{}
	liked_tweets        map[uuid.UUID]struct{}
	removedliked_tweets map[uuid.UUID]struct{}
...
func (m *UserMutation) AddLikedTweetIDs(ids ...uuid.UUID) {
	if m.liked_tweets == nil {
		m.liked_tweets = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
...
func (m *UserMutation) RemoveLikedTweetIDs(ids ...uuid.UUID) {
	if m.removedliked_tweets == nil {
		m.removedliked_tweets = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
...
func (m *UserMutation) RemovedLikedTweetsIDs() (ids []uuid.UUID) {
...
func (m *UserMutation) LikedTweetsIDs() (ids []uuid.UUID) {
