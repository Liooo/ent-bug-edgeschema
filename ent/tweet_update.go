...
func (tu *TweetUpdate) AddLikedUserIDs(ids ...uuid.UUID) *TweetUpdate {
...
func (tu *TweetUpdate) RemoveLikedUserIDs(ids ...uuid.UUID) *TweetUpdate {
...
// AddLikedUserIDs adds the "liked_users" edge to the User entity by IDs.
func (tuo *TweetUpdateOne) AddLikedUserIDs(ids ...uuid.UUID) *TweetUpdateOne {
...
// RemoveLikedUserIDs removes the "liked_users" edge to User entities by IDs.
func (tuo *TweetUpdateOne) RemoveLikedUserIDs(ids ...uuid.UUID) *TweetUpdateOne {
