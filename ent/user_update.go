...
func (uu *UserUpdate) AddLikedTweetIDs(ids ...uuid.UUID) *UserUpdate {
...
func (uu *UserUpdate) RemoveLikedTweetIDs(ids ...uuid.UUID) *UserUpdate {
...
// AddLikedTweetIDs adds the "liked_tweets" edge to the Tweet entity by IDs.
func (uuo *UserUpdateOne) AddLikedTweetIDs(ids ...uuid.UUID) *UserUpdateOne {
...
// RemoveLikedTweetIDs removes the "liked_tweets" edge to Tweet entities by IDs.
func (uuo *UserUpdateOne) RemoveLikedTweetIDs(ids ...uuid.UUID) *UserUpdateOne {
