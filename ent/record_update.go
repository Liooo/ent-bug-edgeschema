...
func (ru *RecordUpdate) AddDataFieldIDs(ids ...uuid.UUID) *RecordUpdate {
	ru.mutation.AddDataFieldIDs(ids...)
	return ru
}

// AddDataFields adds the "data_fields" edges to the DataField entity.
func (ru *RecordUpdate) AddDataFields(d ...*DataField) *RecordUpdate {
	ids := make([]uuid.UUID, len(d))
	for i := range d {
		ids[i] = d[i].ID
	}
	return ru.AddDataFieldIDs(ids...)
}
...
// ClearDataFields clears all "data_fields" edges to the DataField entity.
func (ru *RecordUpdate) ClearDataFields() *RecordUpdate {
	ru.mutation.ClearDataFields()
	return ru
}

// RemoveDataFieldIDs removes the "data_fields" edge to DataField entities by IDs.
func (ru *RecordUpdate) RemoveDataFieldIDs(ids ...uuid.UUID) *RecordUpdate {
	ru.mutation.RemoveDataFieldIDs(ids...)
	return ru
}

// RemoveDataFields removes "data_fields" edges to DataField entities.
func (ru *RecordUpdate) RemoveDataFields(d ...*DataField) *RecordUpdate {
	ids := make([]uuid.UUID, len(d))
	for i := range d {
		ids[i] = d[i].ID
	}
	return ru.RemoveDataFieldIDs(ids...)
}
...
func (ru *RecordUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if ru.mutation.DataFieldsCleared() {
	...
	if nodes := ru.mutation.RemovedDataFieldsIDs(); len(nodes) > 0 && !ru.mutation.DataFieldsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   record.DataFieldsTable,
	...
	if nodes := ru.mutation.DataFieldsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   record.DataFieldsTable,
...
// AddDataFieldIDs adds the "data_fields" edge to the DataField entity by IDs.
func (ruo *RecordUpdateOne) AddDataFieldIDs(ids ...uuid.UUID) *RecordUpdateOne {
	ruo.mutation.AddDataFieldIDs(ids...)
	return ruo
}

// AddDataFields adds the "data_fields" edges to the DataField entity.
func (ruo *RecordUpdateOne) AddDataFields(d ...*DataField) *RecordUpdateOne {
	ids := make([]uuid.UUID, len(d))
	for i := range d {
		ids[i] = d[i].ID
	}
	return ruo.AddDataFieldIDs(ids...)
}
...
// ClearDataFields clears all "data_fields" edges to the DataField entity.
func (ruo *RecordUpdateOne) ClearDataFields() *RecordUpdateOne {
	ruo.mutation.ClearDataFields()
	return ruo
}

// RemoveDataFieldIDs removes the "data_fields" edge to DataField entities by IDs.
func (ruo *RecordUpdateOne) RemoveDataFieldIDs(ids ...uuid.UUID) *RecordUpdateOne {
	ruo.mutation.RemoveDataFieldIDs(ids...)
	return ruo
}

// RemoveDataFields removes "data_fields" edges to DataField entities.
func (ruo *RecordUpdateOne) RemoveDataFields(d ...*DataField) *RecordUpdateOne {
	ids := make([]uuid.UUID, len(d))
	for i := range d {
		ids[i] = d[i].ID
	}
	return ruo.RemoveDataFieldIDs(ids...)
}
...
func (ruo *RecordUpdateOne) sqlSave(ctx context.Context) (_node *Record, err error) {
	...
	if ruo.mutation.DataFieldsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   record.DataFieldsTable,
	...
	if nodes := ruo.mutation.RemovedDataFieldsIDs(); len(nodes) > 0 && !ruo.mutation.DataFieldsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   record.DataFieldsTable,
	...
	if nodes := ruo.mutation.DataFieldsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   record.DataFieldsTable,
